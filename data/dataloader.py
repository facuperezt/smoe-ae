...
class DataLoader:
    ...
    def __init__(self, mode: Literal["dataset", "synthetic"], data_path: str = "", img_size: int = 512, block_size: int = 16, n_repeats: int = 5,
                 force_reinitialize: bool = False, batch_size: int = 25, n_kernels: int = 4, kernels_outside: bool = False,
    ...
    def get_m_blocks_with_n_kernels(self, m: int, n: int, vmin: float = -5, vmax: float = 5, include_zero: bool = True):
    ...
    def get(self, *args, **kwargs):
        if self.mode == "synthetic":
            return self.get_m_blocks_with_n_kernels(*args, **kwargs)
